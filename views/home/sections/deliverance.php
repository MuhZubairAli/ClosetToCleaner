...
Deliverance Section
============================-->
<section id="deliverance">
    <div class="left-img"></div>
    <div class="right-img"></div>
    <div class="container wow fadeInUp">
        <div class="row">
            <div class="col-md-12 deliverance-content">
<!--                <svg id="zd-svg-icon-26-relationshape-talk" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 26 26" style="color:  #212060;fill:  #A1D7D3;width: 80px;">-->
